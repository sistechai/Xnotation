...
function initialiseMachineLearningModal() {
  ...
  registerInitiateMachineLearningViewButtonEventHandlers(displayNextView, setMachineLearningData, closeModal);
  assignInitiateMachineLearningViewLocalVariables();
